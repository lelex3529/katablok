...
export default function BudgetPage({
  ...
  return (
    <div>
      <h2 className='text-2xl font-sora font-bold mb-6'>Détail du budget</h2>
        ...
        <table className='w-full text-left border-collapse'>
          <thead>
            <tr className='border-b-2 border-gray-200'>
              <th className='py-3 px-2 text-gray-700 font-medium'>Section</th>
      ...
      <div className='text-sm text-gray-600 mt-4'>
        ...
        <p>
          * Des frais supplémentaires peuvent s'appliquer pour les déplacements,
          services tiers ou licences si nécessaire.
        </p>
      </div>
    </div>
  );
